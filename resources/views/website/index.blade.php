					...
					<div class="product product-style-2 equal-elem ">
					 ...
					 <div class="product product-style-2 equal-elem ">
						...
						<div class="product-info">
							...
							<div class="wrap-price"><ins><p class="product-price">${{ $product['price']}}</p></ins> <del><p class="product-price">${{ $product['after_discount']}}</p></del></div>
						</div>
					</div>
					 @endforeach
					 @else
						 <h1 class="text-danger ">there is no products now</h1>
					 @endif
